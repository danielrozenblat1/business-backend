...
if(req.body.hasLandingPage){
    try {
        ...
        const mailOptions = {
          ...
          text: "אני מאוד שמח שבחרת לקחת את המושכות לידיים ולתת בי ובידע שלי אמון בכך שהורדת את המדריך משחקי מוחות ! אשמח לשמוע ממך בסוף הקריאה איזה חלקים הכי עזרו לך במדריך ואיזה חלקים פחות, שיהיה המון בהצלחה !" ,
          attachments: [
            {
